      ...
      <div className="col-sm-7 col-md-6">
        ...
        <div className="business-text">
          ...
          og bruk av datasystemer. For mer informasjon om studiet, se NTNU sine
            <a href="http://www.ntnu.no/studier/informasjonsteknologi-informatikk" target="_blank">
              offisielle nettsider.
            </a>
          </p>
          <p>
            Linjeforeningen har gjennom flere år opparbeidet seg et repertoar
            av tjenester som vi tilbyr våre studenter.
            I samarbeid med næringslivet tilbyr vi kurs og bedriftspresentasjoner
            for å gi studentene våre en bredere og dypere
          ...
          <p>
            <span className="sales-contact">
              <span><i className="glyphicon glyphicon-chevron-right"></i>
                <a href="mailto:bedkom@online.ntnu.no" title="bedkom@online.ntnu.no">
