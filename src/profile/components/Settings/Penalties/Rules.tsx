  ...
  <div>
    <div>
      ...
      <p>
        ...
        deg på et arrangement. Hver prikk varer i 30 dager, dersom du får ny prikk og du allerede har en aktiv prikk
        blir de nye 30 dagene lagt til på slutten av virkeperioden til eksisterende prikk(er).
      </p>
      <p>
      ...
      <p>Grunnen til at vi deler ut prikker er å sørge for at medlemmer følger reglene.</p>

      <h3>Generelle regler:</h3>
      <p>
        Det kreves at en møter opp ved påmelding til et arrangement. Dersom du må melde deg av etter avmeldingsfristen
        har gått ut, sender du en mail til den ansvarlige komiteen og melder frafall slik at vi kan gi plassen din
        videre. Du vil få prikk så lenge avmeldingsfristen er ute.
      </p>
      <p>
      ...
      <p>
        Betalingsfrister skal overholdes. Man får en prikk for betaling etter fristen, og utestenging fra alle
        arrangement fram til man har betalt det utestående beløpet.
      </p>
      <p>
        Hvis man er påmeldt et betalingsarrangement, og har betalt, er det ikke mulighet for å få tilbakebetalt pengene
        etter betalingsfristen. Unntak for dette vil være om det er personer på ventelisten. Da kan vi kontakte disse
        for å ta over plassen og betalingen. Dette må avtales med komiteen som har ansvar for betalingsarrangementet.
      ...
      <p>
        Når ventelisten åpner slippes folk inn i den rekkefølgen de er påmeldt. Alle som kommer etter dette havner
        bakerst i køen, uavhengig om du er påmeldt eller står på venteliste.
      </p>
      <p>
        Dersom du kommer etter at ventelisten har åpnet, og arrangementet er fullt, vil du få en prikk. Det kreves at en
        deltager svarer på den elektroniske tilbakemeldingen etter bedriftspresentasjon og kurs. Det vil komme epost
        dagen etter presentasjonen med lenke til tilbakemeldingsskjema som må besvares innen noen få dager (frist er
        oppgitt i eposten). Om en deltager ikke svarer innen fristen vil dette gi en prikk.
      </p>
      ...
      <ul>
        <li>
          For sosiale arrangementer, kontakt <a href="mailto:arrkom@online.ntnu.no">Arrkom</a>.
        </li>
        <li>
          For bedriftspresentasjoner, kontakt <a href="mailto:bedkom@online.ntnu.no">Bedkom</a>.
        </li>
        <li>
          For kurs, kontakt <a href="mailto:fagkom@online.ntnu.no">Fagkom</a>.
        </li>
        <li>
          For generelle henvendelser, kontakt <a href="mailto:hovedstyret@online.ntnu.no">Hovedstyret</a>.
        </li>
      </ul>
