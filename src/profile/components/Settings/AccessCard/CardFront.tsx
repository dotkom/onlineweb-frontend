...
const CardFront = ({ name, studentNumber }: IProps) => (
  <svg viewBox="0 0 216 344" height="100%" width="100%">
    ...
    <text x="8" y="240" width="74" height="15" fill="#3C3A3A">{ name }</text>
    <text x="-205" y="190" width="150" height="150" fontSize="22.6" fontWeight="bold" fill="#3C3A3A" transform="rotate(270)">STUDENT</text>
    <text x="5" y="270" width="74" height="15" fontSize="7.5" fontWeight="500" fill="#3C3A3A">STUDENTNR.:</text>
    <text x="4" y="284" width="74" height="15" fontSize="12.4" fontWeight="500" fill="#3C3A3A">{ studentNumber }</text>
    ...
    <image x="20" y="20" id="image0" width="178" height="48" href="https://innsida.ntnu.no/documents/10157/2546401449/logo_ntnu_bokm-sample-a.png/435f2d98-f0d0-4db8-af20-4b77ba45e27a?t=1456603981519"/>
  </svg>
)
