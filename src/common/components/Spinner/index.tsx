...
const Spinner = ({ primaryColor = '#FAA21B', secondaryColor = '#0060A3', className }: IProps) => (
  <section className={classnames(style.container, className || style.size)}>
    <svg className={style.circle} viewBox="0 0 506 400" fill="none">
      <circle cx="200" cy="200" r="198" transform="translate(53)"
              stroke={secondaryColor} strokeWidth="4" strokeDasharray="48 10"/>
      <circle cx="163" cy="163" r="161" transform="translate(89 36)"
              stroke={secondaryColor} strokeWidth="4" strokeDasharray="42 10"/>
    </svg>
    <svg className={style.lightning} viewBox="0 0 506 400" fill="none">
      ...
      <path d="M41.9012 2.00023C40.8978 12.1069 32.3707 20.0003 22 20.0003C11.6293 20.0003
               3.10217 12.1069 2.09874 2.00022L5.69367 2.00017L20.5 2.00009L36.8063 2.00017L41.9012 2.00023Z"
            transform="translate(292.676 246.907) rotate(142.1)" stroke={primaryColor} strokeWidth="4"/>
      <path d="M262.536 114.961L263.155 118.943L266.792 117.208L480.72 15.1462L230.8 205.969L220.974
               131.11L220.454 127.141L216.791 128.754L19.448 215.658L249.335 30.1025L262.536 114.961Z"
               transform="translate(0 86)" stroke={primaryColor} strokeWidth="6"/>
