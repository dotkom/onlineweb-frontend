 ...
 * To implement it, simply extend this Component, in the render method; use the toggleCollapse method on the trigger button.
 * Then implement a condition for which part(s) will be hidden, e.g. { this.state.collapsed ? <if-hidden> : <if-visible> }.
